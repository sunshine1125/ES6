...
// 找出数组中符合条件的第一个元素
    ...
    console.log(arr3.find(function(value) {
        return value > 2;
    })); // 结果：3
...
// 用指定的值，填充到数组
    let arr5 = [1,2,3];
    console.log(arr5.fill(4)); // 结果：[4,4,4]
// 如果我们想部分填充的话，fill()函数提供了一些参数，用于指定填充的起始位置和结束位置
    let arr6 = [1,2,3];
    console.log(arr6.fill(4, 1, 3)); // 结果：[1, 4, 4], 从位置1的元素开始填充数字4，截止到位置3之前
